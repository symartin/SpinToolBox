...
**
** Created: Thu 22. Nov 18:47:27 2012
...
static const char qt_meta_stringdata_SUiScriptEditor[] = {
    ...
    "open()\0bool\0save()\0saveAs()\0help()\0"
    "documentWasModified()\0execute()\0"
    "switchLexerNormal()\0switchLexerDebugComp()\0"
    "throwKill()\0endKilling()\0index\0"
    "tabDbgCurrentChanged(int)\0"
    "executeSelectedText()\0"
};
...
int SUiScriptEditor::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 15: throwKill(); break;
        case 16: endKilling(); break;
        case 17: tabDbgCurrentChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 18: executeSelectedText(); break;
        default: ;
        }
        _id -= 19;
    }
